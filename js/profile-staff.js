...
if (staffUser.role !== 'staff') window.location.replace(getRoleProfilePage(staffUser.role));
...
(async () => {
    ...
    const assigned = orders.filter(o => o.assignedStaff === staffUser.email).length;
        ...
        <div class="card animate-fade-up">
            ...
            <div class="profile-grid">
                ...
                <div class="profile-facts">
                    ...
                    <div class="profile-fact"><span>Assigned Orders</span><strong>${assigned}</strong></div>
